...
--------------------------------------*/
function btnproduct() {
  $(".slicku").on("click", function (e) {
    e.preventDefault();
    let quantityValue = parseInt(
      e.target.parentNode.nextElementSibling.value
    );
    quantityValue--;
    e.target.parentNode.nextElementSibling.value = quantityValue;
  ...
  $(".slickd").on("click", function (e) {
    ...
    quantityValue++;
    e.target.parentNode.previousElementSibling.value = quantityValue;
